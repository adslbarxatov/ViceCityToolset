...
- [1. Запуск приложения и открытие файлов](#section-1)
- [2. Изменение параметров](#section-2)
- 2.1. Базовые параметры
- [2.2. Параметры игрока](#section-4)
- [2.3. Гаражи](#section-5)
- [2.4. Собираемые объекты](#section-6)
- [2.5. Гангстеры](#section-7)
- [2.6. Парковки](#section-8)
- [2.7. Статистика](#section-9)
- [3. Сброс потенциально опасных параметров](#section-10)
