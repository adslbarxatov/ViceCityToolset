# Конвертор моделей в скрипты коллизий: руководство пользователя
> **ƒ** &nbsp;RD AAOW FDL; 25.11.2025; 0:05
...
игры. Рекомендуется использовать в паре с редактором архива (IMG)
