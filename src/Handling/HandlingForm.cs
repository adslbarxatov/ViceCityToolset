...
namespace RD_AAOW
	...
	public partial class HandlingForm: Form
		...
		public HandlingForm ()
			...
			RDLocale.SetDefaultControlText (SaveCfgFile, RDLDefaultTexts.Button_Save);
			...
			RDLocale.SetControlText (Generic1.Name, AB_L);
			RDLocale.SetControlText (Generic1.Name, AC_L);
			RDLocale.SetControlText (Generic1.Name, AD_L);
			RDLocale.SetControlText (Generic1.Name, AF_L);
			RDLocale.SetControlText (Generic1.Name, AG_L);
			RDLocale.SetControlText (Generic1.Name, B_L);
			RDLocale.SetControlText (Generic1.Name, C_L);
			RDLocale.SetControlText (Generic1.Name, D_L);
			RDLocale.SetControlText (Generic1.Name, E_L);
			RDLocale.SetControlText (Generic1.Name, FGH_L);
			RDLocale.SetControlText (Generic1.Name, F_L);
			RDLocale.SetControlText (Generic1.Name, G_L);
			RDLocale.SetControlText (Generic1.Name, H_L);
			RDLocale.SetControlText (Generic1.Name, I_L);
			RDLocale.SetControlText (Generic1.Name, J_L);
			RDLocale.SetControlText (Generic1.Name, K_L);
			RDLocale.SetControlText (Generic1.Name, L_L);
			RDLocale.SetControlText (Generic1.Name, M_L);
			RDLocale.SetControlText (Generic1.Name, N_L);
			RDLocale.SetControlText (Generic1.Name, O_L);
			RDLocale.SetControlText (Generic1.Name, P_L);
			RDLocale.SetControlText (Generic1.Name, Q_L);
			RDLocale.SetControlText (Generic1.Name, R_L);
			RDLocale.SetControlText (Generic1.Name, S_L);
			RDLocale.SetControlText (Generic1.Name, T_L);
			RDLocale.SetControlText (Generic1.Name, U_L);
			RDLocale.SetControlText (Generic1.Name, V_L);
			RDLocale.SetControlText (Generic1.Name, W_L);
			RDLocale.SetControlText (Generic1.Name, X_L);
			RDLocale.SetControlText (Generic1.Name, Y_L);
			...
			RDLocale.SetControlText (Generic2.Name, AE_1_3);
			RDLocale.SetControlText (Generic2.Name, AE_1_4_L);
			RDLocale.SetControlText (Generic2.Name, AE_2_L);
			RDLocale.SetControlText (Generic2.Name, AE_3_1);
			RDLocale.SetControlText (Generic2.Name, AE_3_4);
			RDLocale.SetControlText (Generic2.Name, AE_4_1);
			RDLocale.SetControlText (Generic2.Name, AE_4_2);
			RDLocale.SetControlText (Generic2.Name, AE_4_3);
			RDLocale.SetControlText (Generic2.Name, AE_4_4);
			RDLocale.SetControlText (Generic2.Name, AE_5_L);
			RDLocale.SetControlText (Generic2.Name, AE_6_1);
			RDLocale.SetControlText (Generic2.Name, AE_6_2);
			RDLocale.SetControlText (Generic2.Name, AE_6_3);
			RDLocale.SetControlText (Generic2.Name, AE_6_4);
			RDLocale.SetControlText (Generic2.Name, AE_7_1);
			RDLocale.SetControlText (Generic2.Name, AE_7_2);
			RDLocale.SetControlText (Generic2.Name, AE_7_3);
			...
			RDLocale.SetControlText (Boat.Name, boat_D_L);
			RDLocale.SetControlText (Boat.Name, boat_E_L);
			RDLocale.SetControlText (Boat.Name, boat_F_L);
			RDLocale.SetControlText (Boat.Name, boat_G_L);
			RDLocale.SetControlText (Boat.Name, boat_H_L);
			RDLocale.SetControlText (Boat.Name, boat_I_L);
			RDLocale.SetControlText (Boat.Name, boat_J_L);
			RDLocale.SetControlText (Boat.Name, boat_K_L);
			RDLocale.SetControlText (Boat.Name, boat_L_L);
			RDLocale.SetControlText (Boat.Name, boat_M_L);
			RDLocale.SetControlText (Boat.Name, boat_N_L);
			RDLocale.SetControlText (Boat.Name, boat_O_L);
			...
			RDLocale.SetControlText (Bike.Name, bike_D_L);
			RDLocale.SetControlText (Bike.Name, bike_E_L);
			RDLocale.SetControlText (Bike.Name, bike_F_L);
			RDLocale.SetControlText (Bike.Name, bike_G_L);
			RDLocale.SetControlText (Bike.Name, bike_H_L);
			RDLocale.SetControlText (Bike.Name, bike_I_L);
			RDLocale.SetControlText (Bike.Name, bike_J_L);
			RDLocale.SetControlText (Bike.Name, bike_K_L);
			RDLocale.SetControlText (Bike.Name, bike_L_L);
			RDLocale.SetControlText (Bike.Name, bike_M_L);
			RDLocale.SetControlText (Bike.Name, bike_N_L);
			RDLocale.SetControlText (Bike.Name, bike_O_L);
			RDLocale.SetControlText (Bike.Name, bike_P_L);
			...
			RDLocale.SetControlText (Flying.Name, flying_D_L);
			RDLocale.SetControlText (Flying.Name, flying_E_L);
			RDLocale.SetControlText (Flying.Name, flying_F_L);
			RDLocale.SetControlText (Flying.Name, flying_G_L);
			RDLocale.SetControlText (Flying.Name, flying_H_L);
			RDLocale.SetControlText (Flying.Name, flying_I_L);
			RDLocale.SetControlText (Flying.Name, flying_J_L);
			RDLocale.SetControlText (Flying.Name, flying_K_L);
			RDLocale.SetControlText (Flying.Name, flying_L_L);
			RDLocale.SetControlText (Flying.Name, flying_M_L);
			RDLocale.SetControlText (Flying.Name, flying_N_L);
			RDLocale.SetControlText (Flying.Name, flying_O_L);
			RDLocale.SetControlText (Flying.Name, flying_P_L);
			RDLocale.SetControlText (Flying.Name, flying_Q_L);
			RDLocale.SetControlText (Flying.Name, flying_R_L);
			RDLocale.SetControlText (Flying.Name, flying_S_L);
