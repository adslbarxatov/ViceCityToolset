...
namespace RD_AAOW
	...
	public partial class CoordsPicker: Form
		...
		public void PickCoords (decimal OldX, decimal OldY, decimal OldZ, decimal OldRotation, bool ViewOnly)
			...
			RDLocale.SetDefaultControlText (PickAbort, RDLDefaultTexts.Button_Close);
			RDLocale.SetDefaultControlText (PickOK, RDLDefaultTexts.Button_Select);
			this.Text =  RDLocale.GetText (this.Name + "_Title");
